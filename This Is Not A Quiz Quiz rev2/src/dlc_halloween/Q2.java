...
public class Q2 extends game.Main {
	...
	public static void display() {
		...
		// Control
		Label question = new Label("Which street name is not real?");
		question.setFont(Font.font(25)); question.setLayoutX(51); question.setLayoutY(50);

		answers[0] = new Button("Small Peepee Dr"); answers[1] = new Button("Poopdeck St"); answers[2] = new Button("Stub Toe Ln"); answers[3] = new Button("Weiner Cutoff Rd");
			...
			if(i != correctAnswer) {
				answers[i].setOnAction(e -> {
					...
					if(lives > 0) {
						...
						window.close();
						gameOver("Spooky!", "Which road would you take?");
					}
				});
			}
		}
