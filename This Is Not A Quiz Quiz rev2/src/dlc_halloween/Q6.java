...
public class Q6 extends game.Main {
	...
	public static void display() {
		...
		// Control
		Label question = new Label("What is a stack?");
		question.setFont(Font.font(25)); question.setLayoutX(51); question.setLayoutY(50);

		answers[0] = new Button("Programmey Type Thing"); answers[1] = new Button("One On Top of the Other"); answers[2] = new Button("Stack of what"); answers[3] = new Button("64");
			...
			if(i != correctAnswer) {
				answers[i].setOnAction(e -> {
					...
					if(lives > 0) {
						...
						window.close();
						gameOver("Spooky!", "Why is it so complicated");
					}
				});
			}
		}
