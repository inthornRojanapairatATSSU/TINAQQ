...
public class Q17 extends game.Main {
	...
	public static void display() {
		...
		// Control
		Label question = new Label("XVII + 0010 1010 + 6B");
		question.setFont(Font.font(25)); question.setLayoutX(51); question.setLayoutY(50);
		question.setTextAlignment(TextAlignment.CENTER);

		answers[0] = new Button("164"); answers[1] = new Button("165"); answers[2] = new Button("166"); answers[3] = new Button("167");
			...
			if(i != correctAnswer) {
				answers[i].setOnAction(e -> {
					...
					if(lives > 0) {
						...
						window.close();
						gameOver("Spooky!", "MATHMATHMAThmathmathmath");
					}
				});
			}
		}
