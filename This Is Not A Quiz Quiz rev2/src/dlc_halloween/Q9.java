...
public class Q9 extends game.Main {
	...
	public static void display() {
		...
		// Control
		Label question = new Label("Can a match box?");
		question.setFont(Font.font(25)); question.setLayoutX(51); question.setLayoutY(50);

		answers[0] = new Button("Yes"); answers[1] = new Button("No"); answers[2] = new Button("No, but a tin can"); answers[3] = new Button("Yes, one beat Mike Tyson");
			...
			if(i != correctAnswer) {
				answers[i].setOnAction(e -> {
					...
					if(lives > 0) {
						...
						window.close();
						gameOver("Spooky!", "I got that reference");
					}
				});
			}
		}
