...
public class Q12 extends game.Main {
	...
	public static void display() {
		...
		answers[0] = new Button("20"); answers[1] = new Button("30"); answers[2] = new Button("25"); answers[3] = new Button("35");
			...
			if(i != correctAnswer) {
				answers[i].setOnAction(e -> {
					...
					if(lives > 0) {
						...
						window.close();
						gameOver("Spooky!", "True veterans ruin their lives 100%'ing a game");
					}
				});
			}
		}
