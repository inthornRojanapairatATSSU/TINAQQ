...
public class Q7 extends game.Main {
	...
	public static void display() {
		...
		// Control
		Label question = new Label("Beta, Alpha, Sigma, ?");
		question.setFont(Font.font(25)); question.setLayoutX(51); question.setLayoutY(50);

		answers[0] = new Button("Chad"); answers[1] = new Button("Tau"); answers[2] = new Button("Sine"); answers[3] = new Button("Fraternity Name Generator");
			...
			if(i != correctAnswer) {
				answers[i].setOnAction(e -> {
					...
					if(lives > 0) {
						...
						window.close();
						gameOver("Spooky!", "Sigma II: The Sequel");
					}
				});
			}
		}
