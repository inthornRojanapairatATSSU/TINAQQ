...
public class Q16 extends game.Main {
	...
	public static void display() {
		...
		// Control
		Label question = new Label("Why can't you address the elephant\nin the room?");
		question.setFont(Font.font(25)); question.setLayoutX(51); question.setLayoutY(50);
		question.setTextAlignment(TextAlignment.CENTER);

		answers[0] = new Button("You won't let me"); answers[1] = new Button("It's too big"); answers[2] = new Button("Questions are unoriginal"); answers[3] = new Button("It's a stealthaphant");
			...
			if(i != correctAnswer) {
				answers[i].setOnAction(e -> {
					...
					if(lives > 0) {
						...
						window.close();
						gameOver("Spooky!", "I can't think of any more questions");
					}
				});
			}
		}
