...
public class Q14 extends game.Main {
	...
	public static void display() {
		...
		window.setTitle("Question 14 | Lives: " +lives +" | No skipping here!");
		
		// Control
		Label question = new Label("I actually don't have one");
		question.setFont(Font.font(25)); question.setLayoutX(51); question.setLayoutY(50);

		answers[0] = new Button("Oh"); answers[1] = new Button("Haha loser"); answers[2] = new Button("That's alright"); answers[3] = new Button("I got a joke");
