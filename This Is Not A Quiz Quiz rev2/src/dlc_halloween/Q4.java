...
public class Q4 extends game.Main {
	...
	public static void display() {
		...
		// Control
		Label question = new Label("Who is the red plumber man?");
		question.setFont(Font.font(25)); question.setLayoutX(51); question.setLayoutY(50);

		answers[0] = new Button("Super Mario Bros."); answers[1] = new Button("Dinosaur Guy"); answers[2] = new Button("Male Plumber"); answers[3] = new Button("Michael");
