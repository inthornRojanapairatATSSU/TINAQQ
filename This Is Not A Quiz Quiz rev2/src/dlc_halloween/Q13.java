...
public class Q13 extends game.Main {
	...
	public static void display() {
		...
		// Control
		Label question = new Label("Wanna hear a funny joke?");
		question.setFont(Font.font(25)); question.setLayoutX(51); question.setLayoutY(50);

		answers[0] = new Button("Ok!"); answers[1] = new Button("No"); answers[2] = new Button("Is it you?"); answers[3] = new Button("Is it this quiz?");
