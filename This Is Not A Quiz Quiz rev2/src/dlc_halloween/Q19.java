...
public class Q19 extends game.Main {
	...
	public static void display() {
		...
		window.setTitle("Question 19 | Lives: " +lives +" | No skipping here!");
		
		// Control
		Label question = new Label("You're close to the end...");
		question.setFont(Font.font(25)); question.setLayoutX(51); question.setLayoutY(50);
		question.setTextAlignment(TextAlignment.CENTER);

		answers[0] = new Button("Tackle it!"); answers[1] = new Button("Run away!"); answers[2] = new Button("Hide somewhere!"); answers[3] = new Button("Step on Lego");
